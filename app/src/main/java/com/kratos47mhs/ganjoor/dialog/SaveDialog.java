...
import com.kratos47mhs.ganjoor.adapter.FolderAdapter;
import com.kratos47mhs.ganjoor.model.Folder;
import com.kratos47mhs.ganjoor.widget.FixedHeightRecyclerView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            new Thread() {
                ...
                public void run() {
                    isWorking = true;
                    current_path = Objects.requireNonNull(getContext()).getFilesDir().getAbsolutePath();
                    try {
            ...
            view.findViewById(R.id.negative_btn).setOnClickListener(view12 -> {
                if (isWorking) return;
                canceled = true;
                dismiss();
            });

            view.findViewById(R.id.new_btn).setOnClickListener(view13 -> {
