package com.kratos47mhs.ganjoor.db;
...
public class Controller {
     ...
     * @param <T>         ModelViewHolder type which extends DatabaseModel
     * @return ModelViewHolder list of notes or categories
     */
    ...
    /**
     * Reads ModelViewHolder note or category from the database
     *
     * @param cls the class of the model type
     * @param id  primary key of note or category
     * @param <T> ModelViewHolder type which extends DatabaseModel
     * @return ModelViewHolder new object of T type
     */
    ...
    /**
     * Deletes ModelViewHolder note or category (and its children) from the database
     *
     * @param ids        ModelViewHolder list of the notes' IDs
    ...
    /**
     * Inserts or updates ModelViewHolder note or category in the database and increments the counter
    ...
    public <T extends DatabaseModel> long saveNote(T note, ContentValues values) {
        ...
        try {
            if (note.id > DatabaseModel.NEW_MODEL_ID) {
                ...
                // Create ModelViewHolder new note
                note.id = db.insert(
                        OpenHelper.TABLE_NOTES,
                        null,
                        values
